...
public class Conditionals {
	...
	public void createConditions() {
		...
		if (ce2) {
			...
			System.out.println("test1 comes first after test2");
		}
	...
	public void createComplexCondition() {
		...
		if (le1) {
			System.out.println("wihtin the range");
		}else {
			System.out.println("invalid data");
		}
		
		// Problem: sickLave (boolean) renderOT (boolean)
...
//		String color =  (choice >= 0 && choice <= 10)? "RED" : "COLORLESS";
