...
public class MyDataType {
	...
	public void assignLiterals() {
		//integral types
		counter = 127; //within range -128, 127
		numProducts = 32000;
		numCells = 787878; // default integer type is int
		numTcellsb = 787878787878L; // caused problem: coercion
									// Perl: '2' + 2 == '4'
									// JavaScript = '2' + 2 = '22'
									// ===
		
		// real number types
		billGatesMoney = 999999999999999.89; // default real type
		weight = 89.5f; 
		...
		// Numercial value - coercion to ASCII only
		letter = 0; // \0
		System.out.println(letter);
		letter = 70;
		System.out.println(letter);
		
		// Unicode charactgers (UTF-8) - hexadecimal form
		letter = '\u00F1';
		System.out.println(letter);
